...
$yorumcek=$yorumlar->fetch(PDO::FETCH_ASSOC); ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="islem.php?yorum_id=<?php echo $yorumcek['yorum_id']; ?>" method="post" enctype="multipart/form-data" >
                <div class="card-body">
                    ...
                    <div class="card-footer">
                      <button type="submit"  name="cevap_duzenle" class="btn btn-primary">Güncelle</button>
                    </div>
              </form>
      </div>
            <!-- /.card -->
